 ...
 * 修改备注：
 */
class MultiRecycleLeftItemViewModel(viewModel: MultiRecycleViewModel, text: String) : MultiItemViewModel<MultiRecycleViewModel>(
        viewModel)
{
    ...
    var itemClick = BindingCommand<Void>(BindingAction {
        ...
        RxToast.normal("我是左侧布局 position：$position")
    })
